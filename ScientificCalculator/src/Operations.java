...
public class Operations extends Frame
{
    ...
    ///////////////////////////
   Operations(String frameText)//constructor
    {
        super(frameText);
...
//set Co-ordinates for Operator Buttons
    ...
    {
        new Operations("Calculator - JavaTpoint");
    }
}
...
class MyDigitButton extends Button implements ActionListener
{
    ...
    //////////////////////////////////////////
    MyDigitButton(int x,int y, int width,int height,String cap, Operations clc)
    {
        super(cap);
...
class MyOperatorButton extends Button implements ActionListener
{
    ...
    MyOperatorButton(int x,int y, int width,int height,String cap, Operations clc)
    {
        super(cap);
        setBounds(x,y,width,height);
        this.cl=clc;
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        if(opText.equals("1/x"))
        {
            ...
            {double tempd=1/(double)temp;
                cl.displayLabel.setText(Operations.getFormattedText(tempd));}
...
// process = button pressed
        ...
        cl.displayLabel.setText(Operations.getFormattedText(temp));
//cl.number=temp;
    }//actionPerformed
}//class
...
class MyMemoryButton extends Button implements ActionListener
{
    ...
    /////////////////////////////////
    MyMemoryButton(int x,int y, int width,int height,String cap,Operations clc)
    {
        super(cap);
        setBounds(x,y,width,height);
        this.cl=clc;
    ...
    public void actionPerformed(ActionEvent ev)
    {
        ...
        switch(memop)
        {
            ...
            case 'R':
                cl.displayLabel.setText(Operations.getFormattedText(cl.memValue));break;
            case 'S':
                cl.memValue=0.0;
            case '+':
...
class MySpecialButton extends Button implements ActionListener
{
    ...
    MySpecialButton(int x,int y, int width,int height,String cap, Operations clc)
    {
        super(cap);
        setBounds(x,y,width,height);
        this.cl=clc;
